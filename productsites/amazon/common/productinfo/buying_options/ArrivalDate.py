...
class ArrivalDate:
    @staticmethod
    def get_product_arrival_date(buying_options):
        try:
            if buying_options['arrives_date1']:
                return ArrivalDate.format_arrival_date(buying_options['arrives_date1'])
            elif buying_options['arrives_date2']:
                return ArrivalDate.format_arrival_date(buying_options['arrives_date2'])
